 ...
 * @property string $primaryJob
 * @property boolean $unionMember
 * @property boolean $dangvien
 ...
 * @property-read Collection|\App\Models\user_insurance[] $user_insurances
...
class User extends BaseModel implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract
{
    ...
    public function user_insurances(): HasMany
    {
        return $this->hasMany(user_insurance::class);
    }

    public function user_salarys(): HasMany
    {
        return $this->hasMany(user_salary::class);
    }

    public function user_trainings(): HasMany
    {
