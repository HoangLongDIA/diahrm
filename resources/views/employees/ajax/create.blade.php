        ...
        <x-form id="save-employee-data-form">
            ...
            <div class="bg-white rounded add-client">
                ...
                <div class="p-20 row">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="form-group my-3">
                                    <label class="f-14 text-dark-grey mb-12" data-label="true" for="employee_id" style="font-weight: bold">Employee ID
                                        <sup class="f-14 mr-1">*</sup>

                                        <svg class="svg-inline--fa fa-question-circle fa-w-16" data-toggle="popover" data-placement="top" data-content="<p>Unique ID you use to identify employees in your organization.</p><p>For employees created through <b>Invite</b>, an employee id is automatically generated, which you can change later.</p>" data-html="true" data-trigger="hover" aria-hidden="true" focusable="false" data-prefix="fa" data-icon="question-circle" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="" data-original-title="" title=""><path fill="currentColor" d="M504 256c0 136.997-111.043 248-248 248S8 392.997 8 256C8 119.083 119.043 8 256 8s248 111.083 248 248zM262.655 90c-54.497 0-89.255 22.957-116.549 63.758-3.536 5.286-2.353 12.415 2.715 16.258l34.699 26.31c5.205 3.947 12.621 3.008 16.665-2.122 17.864-22.658 30.113-35.797 57.303-35.797 20.429 0 45.698 13.148 45.698 32.958 0 14.976-12.363 22.667-32.534 33.976C247.128 238.528 216 254.941 216 296v4c0 6.627 5.373 12 12 12h56c6.627 0 12-5.373 12-12v-1.333c0-28.462 83.186-29.647 83.186-106.667 0-58.002-60.165-102-116.531-102zM256 338c-25.365 0-46 20.635-46 46 0 25.364 20.635 46 46 46s46-20.636 46-46c0-25.365-20.635-46-46-46z"></path></svg><!-- <i class="fa fa-question-circle" data-toggle="popover" data-placement="top" data-content="<p>Unique ID you use to identify employees in your organization.</p><p>For employees created through <b>Invite</b>, an employee id is automatically generated, which you can change later.</p>" data-html="true" data-trigger="hover"></i> Font Awesome fontawesome.com -->
                                    </label>

                                    <input contenteditable="false" type="text" class="form-control height-35 f-14" placeholder="Employee ID is the unique ID distributed to employees" value="{{ (!$checkifExistEmployeeId) ? ($lastEmployeeID+1) : '' }}" name="employee_id" id="employee_id" autocomplete="off">
                                ...
                                <x-forms.select fieldId="country" :fieldLabel="__('app.country')" fieldName="country"
                                    ...
                                    @foreach ($countries as $item)
                                        <option data-tokens="{{ $item->iso3 }}" data-phonecode = "{{$item->phonecode}}"
                                                ...
                                                value="{{ $item->id }}" {{ $item->id == 232 ? 'selected' : '' }}>{{ $item->nicename }}</option>
                                    @endforeach
                                </x-forms.select>
                            </div>
                            <div class="col-lg-2 col-md-3">
                                <x-forms.text fieldId="folk" :fieldLabel="__('app.folk')"
                                               fieldName="folk" fieldRequired="true">
                                </x-forms.text>
                            </div>
                            <div class="col-lg-2 col-md-3">
                                <x-forms.text fieldId="religion" :fieldLabel="__('app.religion')"
                                              fieldName="religion" fieldRequired="true">
                                </x-forms.text>
                            </div>
                        </div>
                    </div>
                            ...
                            <x-forms.select fieldId="country_phonecode" fieldName="country_phonecode"
                                ...
                                @foreach ($countries as $item)
                                    <option data-tokens="{{ $item->name }}"
                                            ...
                                            value="{{ $item->phonecode }}" {{ $item->phonecode == 84 ? 'selected' : '' }}>{{ $item->phonecode }}
                                    </option>
                                @endforeach
                            </x-forms.select>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="reporting_to" :fieldLabel="__('app.reportingTo')"
                    ...
                    <div class="col-lg-2 col-md-3">
                        <x-forms.label class="my-3" fieldId="educationLevel"
                                       :fieldLabel="__('app.educationLevel')" fieldRequired="true">
                        </x-forms.label>
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="educationLevel"
                ...
                <div class="p-20 row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="my-3 form-group">
                            <label class="mb-12 f-14 text-dark-grey w-100"
                                   for="usr">@lang('app.unionMember')</label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="unionMember-yes" :fieldLabel="__('app.yes')" fieldName="unionMember"
                                               fieldValue="enable" checked="true">
                                </x-forms.radio>
                                <x-forms.radio fieldId="unionMember-no" :fieldLabel="__('app.no')" fieldValue="disable"
                                               fieldName="unionMember"></x-forms.radio>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="my-3 form-group">
                            <label class="mb-12 f-14 text-dark-grey w-100"
                                   for="usr">@lang('app.dangvien')</label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="dangvien-yes" :fieldLabel="__('app.yes')" fieldName="dangvien"
                                               fieldValue="disable">
                                </x-forms.radio>
                                <x-forms.radio fieldId="dangvien-no" :fieldLabel="__('app.no')" fieldValue="enable"
                                               fieldName="dangvien" checked="true">></x-forms.radio>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="my-3 form-group">
                            <label class="mb-12 f-14 text-dark-grey w-100"
                                   for="usr">@lang('app.cuucb')</label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="cuucb-yes" :fieldLabel="__('app.yes')" fieldName="cuucb"
                                               fieldValue="disable">
                                </x-forms.radio>
                                <x-forms.radio fieldId="cuucb-no" :fieldLabel="__('app.no')" fieldValue="enable"
                                               fieldName="cuucb" checked="true">></x-forms.radio>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="my-3 form-group">
                            <label class="mb-12 f-14 text-dark-grey w-100"
                                   for="usr">@lang('app.dqtv')</label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="dqtv-yes" :fieldLabel="__('app.yes')" fieldName="dqtv"
                                               fieldValue="disable">
                                </x-forms.radio>
                                <x-forms.radio fieldId="dqtv-no" :fieldLabel="__('app.no')" fieldValue="enable"
                                               fieldName="dqtv" checked="true">></x-forms.radio>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="my-3 form-group">
                            <label class="mb-12 f-14 text-dark-grey w-100"
                                   for="usr">@lang('app.pccs')</label>
                            <div class="d-flex">
                                <x-forms.radio fieldId="pccs-yes" :fieldLabel="__('app.yes')" fieldName="pccs"
                                               fieldValue="disable">
                                </x-forms.radio>
                                <x-forms.radio fieldId="pccs-no" :fieldLabel="__('app.no')" fieldValue="enable"
                                               fieldName="pccs" checked="true">></x-forms.radio>
                            </div>
                        </div>
                    </div>
